...
router.get('/dashboard', (req, res) => {
  const query = `select (select count(*) from records 
	where ('month', records.date) =  date_part('month',now()) 
		AND date_part('year', records.date) = date_part('year',now()) 
		) as month_records, (select sum(amount) from records) as total_amount;`
